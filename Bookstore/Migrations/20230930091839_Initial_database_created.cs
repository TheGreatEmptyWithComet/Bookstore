...
{
    /// <inheritdoc />
    public partial class Initial_database_created : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSequel = table.Column<bool>(type: "bit", nullable: true),
                    BookAsPrequel = table.Column<int>(type: "int", nullable: true),
                    IsNewArrival = table.Column<bool>(type: "bit", nullable: true),
                    ReservedForCustomerId = table.Column<int>(type: "int", nullable: true),
                    BookAsOriginReference = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BookAsOriginReference,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Books_BookAsPrequel",
                        column: x => x.BookAsPrequel,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Campaings_CampaingId",
                        column: x => x.CampaingId,
                        principalTable: "Campaings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Customers_ReservedForCustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_BookAsPrequel",
                table: "Books",
                column: "BookAsPrequel");

            migrationBuilder.CreateIndex(
                name: "IX_Books_CampaingId",
                table: "Books",
                column: "CampaingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_ReservedForCustomerId",
                table: "Books",
